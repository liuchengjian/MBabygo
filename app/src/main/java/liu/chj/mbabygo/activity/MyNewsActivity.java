 ...
 * 注释：
 */
public class MyNewsActivity extends AutoLayoutActivity implements View.OnClickListener{
    //返回按钮
    @ViewInject(R.id.iv_my_new_back)
    private ImageView iv_my_new_back;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        x.view().inject(this);
        mSwipeMenuRecyclerView = (SwipeMenuRecyclerView)findViewById(R.id.smr_my_new);
        mSwipeMenuRecyclerView.setLayoutManager(new LinearLayoutManager(this));// 布局管理器。
        mSwipeMenuRecyclerView.setHasFixedSize(true);// 如果Item够简单，高度是确定的，打开FixSize将提高性能。
        mSwipeMenuRecyclerView.setItemAnimator(new DefaultItemAnimator());// 设置Item默认动画，加也行，不加也行。
        mSwipeMenuRecyclerView.addItemDecoration(new followerDecoration());// 添加分割线。
        //设置监听
        mContext = this;
    ...
    public void setlisten(){
        iv_my_new_back.setOnClickListener(this);
    }
